...
testUserSchema.virtual('calculatedTotalScore').get(function () {
...
const testingUser = mongoose.model("testingUser", testUserSchema);
module.exports = { testingUser, validateUser };
